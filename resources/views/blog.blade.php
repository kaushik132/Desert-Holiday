        ...
        <section class="blog-section">
            ...
            <div class="container">
                ...
                <div class="d-flex justify-content-between align-items-center mb-2 md-mb-4">
                    ...
                    <a href="{{ url('blog') }}" class="view-all-btn">
                        ...
                        <a href="{{ 'blog-detail/'. $newblog->slug }}">
                            <div class="blog-card blog-large p-0">
                                ...
                                <div class="blog-overlay">
                                    <span class="blog-tag custom-b-span">{{ $newblog->category->name }}</span>
                                    <h4>{{ $newblog->title }}</h4>
                                    <div class="blog-meta">

                                        <span><i class="fa-regular fa-calendar"></i> {{ $newblog->created_at->format('d F, Y') }}</span>
                                    ...
                                    <a href="{{ 'blog-detail/' . $rendom->slug }}">
                                        <div class="blog-card blog-small d-flex">
                                            ...
                                            <div class="blog-content">
                                                <span class="blog-tag">{{ $rendom->category->name }}</span>
                                                <h5>{{ $rendom->title }}</h5>
                                                <div class="blog-meta">
                                                    <span>{{ $rendom->created_at->format('d F, Y') }}</span>
