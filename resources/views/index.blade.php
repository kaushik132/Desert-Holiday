    ...
    <main>
        ...
        <section class="hero-section">
            ...
            <div class="container hero-content">
                ...
                <p>
                    Discover carefully curated tour packages with transparent pricing, expert planning, and end-to-end
                    travel support for a smooth and memorable journey.
                </p>

                <div class="hero-buttons">
                    <a href="{{ url('destination') }}" class="theme-btn">Start Exploring</a>
                    <a href="{{ url('contact') }}" class="theme-btn-2">
                ...
                <div class="owl-carousel cardCarousel">
                    @foreach ($destinationCategories as $destinationCategories)
                        <div class="destination-card">
                            <img src="{{ url('uploads/' . $destinationCategories->thumb_image) }}"
                                alt="{{ $destinationCategories->alt }}">
                            <h6>{{ $destinationCategories->title }}</h6>
                    ...
                    @foreach ($destinationCategoriess as $destinationCategoriesss)
                        <a href="{{ url('destination/' . $destinationCategoriesss->slug) }}">
                            <div class="category-item text-center">
                                <img src="{{ url('uploads/' . $destinationCategoriesss->image) }}" class="rounded-circle"
                                    alt="{{ $destinationCategoriesss->alt }}">
                                    ...
                                    <div class="featured-card">
                                        <div class="featured-img">
                                            ...
                                            <div class="top-btn-icon">
                                                ...
                                                <div class="top-icon">
                                                    <img src="{{ asset('assets/images/heart.png') }}" alt="hart">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="featured-content">
                                            ...
                                            <span><i class="fa-solid fa-clock"></i>
                                                {{ $destination->tour_duration }}</span>
                                            &nbsp;&nbsp;
                                            ...
                                            <ul>
                                                ...
                                                <li class="theme-btn cus-btn">Enquire Now</li>
                                            </ul>
            ...
            <div class="container">
                <ul class="heading-store">
                    <li class="">
                        ...
                        <p class="section-subtitle text-start">Find the perfect travel experience based on your interests
                            and travel style.</p>
                    </li>
                    <li><a href="{{ url('destination') }}">View All</a></li>
                </ul>
                    ...
                    @foreach ($category as $cat)
                        <div class="item">
                            <div class="top-travel-card">
                                <img src="{{ url('uploads/' . $cat->image) }}" alt="{{ $cat->alt }}">
        ...
        <section class="testimonials position-relative">
            <div class="container">
                <ul class="heading-store">
                    <li class="">
                        <h2 class="section-title text-start">Top Travel Categories</h2>
                        <p class="section-subtitle mb-4 text-start">Find the perfect travel experience based on your
        ...
        <section class="travel-story">
            <div class="container">
                ...
                <ul class="heading-store">
                    <li class="">
                        <h2 class="section-title text-start">Recent Blog</h2>
